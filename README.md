# APP开发-后管功能快速开发平台(原JEESITE基础上去除流程相关功能和内容管理相关功能)
...
* 工具类：Apache Commons、Jackson 2.2、Xstream 1.4、Dozer 5.3、POI 3.9、Google guava
...
* 服务器中间件：在Java EE 5规范（Servlet 3、JSP 2.2）下开发，支持应用服务器中间件
有Tomcat 7+、Jboss 7+、WebLogic 10+、WebSphere 8+。
